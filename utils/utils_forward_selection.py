...
def get_max_idxs(accuracies_list, max_accuracy, sensors_idxs):
    """
    Returns the index or indexes that gives the max accuracy in the curent
    forward selection iteration.
    --------------------------------------------------------------------------
    Parameters
        
    accuracies_list: list
        List of all the combination's accuracies from the current
        forward selection iteration.
...
def get_combinations(max_acc_idxs, sensors_idxs):
    """
    Retorna listas que contienen las combinaciones a evaluar en la siguiente
    iteración del forward selection, fijando la mejor combinación de la
    iteración anterior.
    --------------------------------------------------------------------------
    Parameters      
...
#%%
def save_accuracies(models_dict, condition_name, cond_accuracies,
                    win_olap_str):
    """
